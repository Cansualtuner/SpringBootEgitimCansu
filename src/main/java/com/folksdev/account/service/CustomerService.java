...
public class CustomerService {
    ...
    protected Customer findCustomerById(String id){
        return customerRepository.findById(id).orElseThrow(() -> new CustomerNotFoundException("Cutsomer could not find by id" + id));
    ...
    public CustomerDto getCustomerById(String customerId) {
        ...
        return converter.converToCustomerDto(findCustomerById(customerId));
    }
}
